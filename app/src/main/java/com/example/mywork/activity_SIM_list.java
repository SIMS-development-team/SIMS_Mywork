...
public class activity_SIM_list extends AppCompatActivity {
    ...
    private void customDialog(String Sid) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity_SIM_list.this);
        final AlertDialog dialog = builder.create();
        View dialogView = View.inflate(activity_SIM_list.this, R.layout.activity_custom, null);
